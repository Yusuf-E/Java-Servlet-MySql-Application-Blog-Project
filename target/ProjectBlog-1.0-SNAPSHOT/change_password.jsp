  ...
  <div class="row">
    ...
    <div class="col-sm-6">
      <form action="change-password" method="post" >
        ...
        <div class="mb-3">
          <input value="" type="password" name="oldPassword" placeholder="Eski Şifreniz" class="form-control" required />
        </div>
        <div class="mb-3">
          <input value="" type="password" name="newPassword" placeholder="Yeni Şifre" class="form-control" required />
        </div>
        <div class="mb-3">
          <input value="" type="password" name="repeatPassword" placeholder="Yeni Şifre Tekrar" class="form-control" required />
        </div>
